  ...
  return (
    <section className="about">
      <div className="about-container">
        <div className="about-image wood-panel">
          <img
        ...
        <div className="about-content wood-panel">
          <span className="about-tag"><FaLeaf /> Who We Are</span>
          ...
          <button><FaTree /> Learn More</button>
        </div>
      </div>
    </section>
  );
